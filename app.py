...
#create map
m = folium.Map(location=[48.51962033618168, 9.053572913135799], zoom_start=15)
...
popup_start = folium.Popup(iframe_start, min_width=150, max_width=150, min_height=140, max_height=140)
...
for i in range(len(data)):
    ...
    # set other locations
        ...
        popup_reg = folium.Popup(iframe_reg, min_width=200, max_width=200, min_height=100, max_height=100)
        # star marker
